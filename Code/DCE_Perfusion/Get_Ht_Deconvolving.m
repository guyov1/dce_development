...
if(exist(Mat_File_Perfusion_Parameters,'file') && ~Force_RealData_Calc)
    ...
    if Parallel_Real_Data_Est
        [ Flow_vec_with_Delay, Flow_vec_no_Delay, Delay_sec_by_Max_Val_with_Delay, Delay_sec_by_Max_Val_no_Delay, ...
          t_delay_single_gauss_sec, sigma_seconds_single_gauss, ...
          Amp_single_gauss, fitted_larsson_with_Delay, fitted_larsson_no_Delay, fitted_larsson_no_Delay_High_F, fitted_larsson_no_Delay_no_E, fitted_larsson_no_Delay_no_E_High_F, fitted_gaussian, ...
          fitted_double_gaussian, double_gaussian_param_vec, Ktrans_with_Delay_vec, Ktrans_no_Delay_vec, ...
          E_with_Delay, E_no_Delay, E_no_Delay_High_F, Vb_with_Delay, Vb_no_Delay, Vb_no_Delay_High_F, Vb_no_Delay_no_E, Vb_no_Delay_no_E_High_F, ...
    ...
    save(Mat_File_Perfusion_Parameters,'Flow_vec_with_Delay','Flow_vec_no_Delay','t_delay_single_gauss_sec','sigma_seconds_single_gauss',...
        'Amp_single_gauss', 'Ktrans_with_Delay_vec','Ktrans_no_Delay_vec', 'E_with_Delay', 'E_no_Delay', 'E_no_Delay_High_F', ...
        'Vb_with_Delay', 'Vb_no_Delay', 'Vb_no_Delay_High_F', 'Vb_no_Delay_no_E', 'Vb_no_Delay_no_E_High_F', ...
        'Ve_with_Delay', 'Ve_no_Delay', 'Ve_no_Delay_High_F', 'Ve_no_Delay_no_E', 'MTT_with_Delay', 'MTT_no_Delay',...
        'Ktrans_Patlak_with_Delay_vec','Ktrans_Patlak_no_Delay_vec', 'Vb_Patlak_with_Delay_vec','Vb_Patlak_no_Delay_vec',...
        ...
        'fitted_larsson_with_Delay','fitted_larsson_no_Delay', 'fitted_larsson_no_Delay_High_F', 'fitted_larsson_no_Delay_no_E', 'fitted_larsson_no_Delay_no_E_High_F');
